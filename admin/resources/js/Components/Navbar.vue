...
<template>
    <div>
        <!-- Combined Mobile Navigation (visible on mobile) -->
        <nav aria-label="mobile-nav"
            class="sticky top-0 z-10 px-4 py-3 bg-white flex items-center justify-between transition-transform duration-500 dark:bg-dark-eval-1 md:hidden">
            <!-- Left Side: Dashboard Link & Logo -->
            ...
            <div class="flex items-center gap-2">
                ...
                <Button iconOnly variant="secondary" type="button" @click="() => { toggleDarkMode() }"
                    v-slot="{ iconSizeClasses }" srText="Toggle dark mode">
                ...
                <Dropdown align="right" width="48">
                    <template #trigger>
                        <span class="inline-flex rounded-md">
                            <button type="button"
                                class="inline-flex items-center px-2 py-1 text-sm font-medium text-gray-500 transition duration-150 ease-in-out bg-white border border-transparent rounded-md hover:text-gray-700 focus:outline-none focus:ring focus:ring-purple-500 focus:ring-offset-1 focus:ring-offset-white dark:focus:ring-offset-dark-eval-1 dark:bg-dark-eval-1 dark:text-gray-400 dark:hover:text-gray-200">
        ...
        <nav aria-label="secondary" :class="[
            ...
            <div class="flex items-center gap-2">
                ...
                <Button iconOnly variant="secondary" type="button" @click="toggleFullScreen"
                    v-slot="{ iconSizeClasses }" srText="Toggle fullscreen">
