    ...
    <DaisyTable :data="announcements.data" :excludedColumns="['id', 'content']"
        ...
        <template #actions="{ row }">
            <div class="flex gap-2">
                <button @click="view(row)" class="btn text-white btn-primary shadow-lg hover:bg-blue-700 mb-2">
                    View
                </button>
                <button @click="edit(row)" class="btn text-white btn-warning shadow-lg hover:bg-yellow-600 mb-2">
                    Edit
                </button>
